...
"""Parallel-GAN training and inference pipeline.

This module provides the :class:`ParallelGANConfig` dataclass and
:class:`ParallelGANTrainer` class for two-stage Parallel-GAN training:

* **Stage 1** – reconstruction (``train_step_recon``).
* **Stage 2** – translation with hierarchical feature loss (``train_step_trans``).
