...
"""E3Diff training and inference pipeline.

This module provides the :class:`E3DiffConfig` dataclass and
:class:`E3DiffTrainer` class for two-stage E3Diff training:

* **Stage 1** – diffusion noise-prediction training (``train_step_stage1``).
* **Stage 2** – one-step DDIM + GAN adversarial fine-tuning (``train_step_stage2``).
